...
use backend\models\RiwayatGolRuangSearch;
...
/**
 * RiwayatGolRuangController implements the CRUD actions for RiwayatGolRuang model.
 */
class RiwayatGolRuangController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new RiwayatGolRuangSearch();
