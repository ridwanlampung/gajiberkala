...
/**
 * RiwayatGajiBerkalaSearch represents the model behind the search form of `common\Models\RiwayatGajiBerkala`.
 */
class RiwayatGajiBerkalaSearch extends RiwayatGajiBerkala
{
    /**
     * {@inheritdoc}
     */
